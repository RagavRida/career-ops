...
const leakPatterns = [
  'Raghavendra', 'raghavendramachikatla', 'Santifer iRepair', 'Zinkee', 'ALMAS',
  'raghavendramachikatla@example.com', '688921377', '/Users/raghavendramachikatla/',
];

const scanExtensions = ['md', 'yml', 'html', 'mjs', 'sh', 'go', 'json'];
const allowedFiles = [
  // English README + localized translations (all legitimately credit Raghavendra)
