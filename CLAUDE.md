...
This system was built and used by [raghavendramachikatla](https://github.com/raghavendramachikatla) to evaluate 740+ job offers, generate 100+ tailored CVs, and land a Head of Applied AI role. The archetypes, scoring logic, negotiation scripts, and proof point structure all reflect his specific career search in AI/automation roles.

The portfolio that goes with this system is also open source: [cv-santiago](https://github.com/raghavendramachikatla/cv-santiago).
...
| `/career-ops-compare` | `/career-ops evaluates` | Compare and rank multiple offers |
...
>
> Tip: Having a personal portfolio dramatically improves your job search. If you don't have one yet, the author's portfolio is also open source: github.com/raghavendramachikatla/cv-santiago — feel free to fork it and make it yours."
...
- **Support**: help questions go to Discussions, not issues (see `SUPPORT.md`)
